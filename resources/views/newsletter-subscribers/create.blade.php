...
@section('title', 'Create Newsletter Subscriber')
...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Newsletter Subscriber</span>
@endsection

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>Create Newsletter Subscriber</h2>
            <p>Add a new newsletter subscriber to the system</p>
        </div>
