...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Testimonial</span>
@endsection
...
@section('content')
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Add a new testimonial to the system</p>
        </div>
            ...
            <div class="form-grid form-grid-3">
                <div class="form-group">
                    ...
                    <input type="text" id="user-name" name="user_name"
                        class="form-input @error('user_name') error @enderror" value="{{ old('user_name') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="user-role" name="user_role"
                        class="form-input @error('user_role') error @enderror" value="{{ old('user_role') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="rating" name="rating" class="form-input @error('rating') error @enderror"
                        value="{{ old('rating') }}" placeholder="Enter rating" required>
                    @error('rating')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-grid">
                <div class="form-group full-width">
                    ...
                    <textarea id="message" name="message" class="form-input @error('message') error @enderror"
                        value="{{ old('message') }}" placeholder="Enter message"></textarea>
                    @error('message')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
