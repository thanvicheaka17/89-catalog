...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Tool Category</span>
@endsection
...
@section('content')
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p>Add a new tool category to the system</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ route('system-management.tool-categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
