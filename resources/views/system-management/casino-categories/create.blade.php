...
@section('title', 'Create Casino Category')
...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Casino Category</span>
@endsection

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>Create Casino Category</h2>
            <p>Create a new casino category</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ route('system-management.casino-categories.store') }}" method="POST"
