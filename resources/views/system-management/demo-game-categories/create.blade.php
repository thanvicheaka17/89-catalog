...
@section('title', 'Create Demo Game Category')
...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Demo Game Category</span>
@endsection

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>Create Demo Game Category</h2>
            <p>Add a new demo game category to the system</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ route('system-management.demo-game-categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-grid form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="category-slug" name="slug" class="form-input @error('slug') error @enderror" value="{{ old('slug') }}" placeholder="Enter slug" required>
                    @error('slug')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
