...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Game</span>
@endsection
...
@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>Create Game</h2>
            <p>Add a new game to the system</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ route('game-management.games.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-grid">
                <div class="form-group full-width">
                    ...
                    <textarea id="description" name="description" class="form-input @error('description') error @enderror" placeholder="Enter description">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('game-management.games.index') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
@endsection
