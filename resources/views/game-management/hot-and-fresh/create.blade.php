...
@section('title', 'Create Hot & Fresh')
...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item active">Create Hot & Fresh</span>
@endsection

@section('content')
    <div class="page-header">
        <div class="page-header-left">
            <h2>Create Hot & Fresh</h2>
            <p>Add a new hot & fresh to the system</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ route('game-management.hot-and-fresh.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
